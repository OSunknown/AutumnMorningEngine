...
void ColorShaderClass::OutputShaderErrorMessage(ID3D10Blob * errorMessage, HWND hWnd, WCHAR * shaderFilename)
{
	...
	//Get a pointer to the error message text bubfer
	...
	errorMessage = 0;
	//Pop a message up on the screen to notify the user to check the text file for complie errors
...
bool ColorShaderClass::SetShaderParameters(ID3D11DeviceContext * deviceContext, Matrix4 worldMatrix, Matrix4 viewMatrix, Matrix4 projectionMatrix)
{
	...
	//Finanly set hte  constant buffer in the vertex shader with the updated value
