...
bool FontShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"../AutumnMorningEngine/font.vs", L"../AutumnMorningEngine/font.ps");
	if(!result)
	{
		return false;
	}
...
bool FontShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, Matrix4 worldMatrix, Matrix4 viewMatrix, 
							 Matrix4 projectionMatrix, ID3D11ShaderResourceView* texture, Vector4 pixelColor)
{
	bool result;
...
bool FontShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, Matrix4 worldMatrix, Matrix4 viewMatrix, 
										  Matrix4 projectionMatrix, ID3D11ShaderResourceView* texture, Vector4 pixelColor)
{
	HRESULT result;
