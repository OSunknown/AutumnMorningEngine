...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hWnd)
{
	...
	result = m_Model->Initialize(m_D3D->GetDevice(), L"../AutumnMorningEngine/data/seafloor.dds", "../AutumnMorningEngine/data/sphere.txt");
	if (!result)
	{
...
{
	Matrix4 viewMatrix , projectionMatrix, worldMatrix, orthoMatrix;
	...
	for (index = 0; index<modelCount; index++)
	{
		...
		if (renderModel)
		{
			...
			MatrixTranslation(&worldMatrix, positionX, positionY, positionZ);
