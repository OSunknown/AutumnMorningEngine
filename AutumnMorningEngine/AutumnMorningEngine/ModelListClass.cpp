...
bool ModelListClass::Initialize(int numModels)
{
	...
	for(i=0; i<m_modelCount; i++)
	{
		...
		m_ModelInfoList[i].color = Vector4(red, green, blue, 1.0f);
...
void ModelListClass::GetData(int index, float& positionX, float& positionY, float& positionZ, Vector4& color)
{
