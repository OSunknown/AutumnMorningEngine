						   ...
						   Matrix4 baseViewMatrix)
{
	...
	result = m_Font->Initialize(device, "../AutumnMorningEngine/data/fontdata.txt", L"../AutumnMorningEngine/data/font.dds");
	if(!result)
	{
...
bool TextClass::Render(ID3D11DeviceContext* deviceContext, Matrix4 worldMatrix, Matrix4 orthoMatrix)
{
	bool result;
...
bool TextClass::RenderSentence(ID3D11DeviceContext* deviceContext, SentenceType* sentence, Matrix4 worldMatrix, 
							   Matrix4 orthoMatrix)
{
